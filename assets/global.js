...
class VariantSelects extends HTMLElement {
  ...
  renderProductInfo() {
    ...
    .then((responseText) => {
      ...
      const priceDestinations = document.querySelectorAll(`[id^="price-${this.dataset.section}"]`);
      const priceSources = html.querySelectorAll(`[id^="price-${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}"]`);

      priceDestinations.forEach((destination, index) => {
        const source = priceSources[index];
